...
seg.m_sides [0].uvls [0].u = 0;
seg.m_sides [0].uvls [0].v = 0;
seg.m_sides [0].uvls [0].l = 0x8000U;
seg.m_sides [0].uvls [1].u = 0;
seg.m_sides [0].uvls [1].v = 2047;
seg.m_sides [0].uvls [1].l = 511;
seg.m_sides [0].uvls [2].u = - 2048;
seg.m_sides [0].uvls [2].v = 2047;
seg.m_sides [0].uvls [2].l = 3833;
seg.m_sides [0].uvls [3].u = - 2048;
seg.m_sides [0].uvls [3].v = 0;
seg.m_sides [0].uvls [3].l = 0x8000U;

seg.m_sides [1].m_info.nWall = NO_WALL;
seg.m_sides [1].m_info.nBaseTex = 263;
seg.m_sides [1].m_info.nOvlTex = 264;
seg.m_sides [1].uvls [0].u = 0;
seg.m_sides [1].uvls [0].v = 0;
seg.m_sides [1].uvls [0].l = 0x8000U;
seg.m_sides [1].uvls [1].u = 0;
seg.m_sides [1].uvls [1].v = 2047;
seg.m_sides [1].uvls [1].l = 0x8000U;
seg.m_sides [1].uvls [2].u = - 2048;
seg.m_sides [1].uvls [2].v = 2047;
seg.m_sides [1].uvls [2].l = 0x8000U;
seg.m_sides [1].uvls [3].u = - 2048;
seg.m_sides [1].uvls [3].v = 0;
seg.m_sides [1].uvls [3].l = 0x8000U;

seg.m_sides [2].m_info.nWall = NO_WALL;
seg.m_sides [2].m_info.nBaseTex = 0;
seg.m_sides [2].m_info.nOvlTex = 0;
seg.m_sides [2].uvls [0].u = 0;
seg.m_sides [2].uvls [0].v = 0;
seg.m_sides [2].uvls [0].l = 0x8000U;
seg.m_sides [2].uvls [1].u = 0;
seg.m_sides [2].uvls [1].v = 2047;
seg.m_sides [2].uvls [1].l = 3836;
seg.m_sides [2].uvls [2].u = - 2048;
seg.m_sides [2].uvls [2].v = 2047;
seg.m_sides [2].uvls [2].l = 5126;
seg.m_sides [2].uvls [3].u = - 2048;
seg.m_sides [2].uvls [3].v = 0;
seg.m_sides [2].uvls [3].l = 0x8000U;

seg.m_sides [3].m_info.nWall = NO_WALL;
seg.m_sides [3].m_info.nBaseTex = 270;
seg.m_sides [3].m_info.nOvlTex = 0;
seg.m_sides [3].uvls [0].u = 0;
seg.m_sides [3].uvls [0].v = 0;
seg.m_sides [3].uvls [0].l = 11678;
seg.m_sides [3].uvls [1].u = 0;
seg.m_sides [3].uvls [1].v = 2047;
seg.m_sides [3].uvls [1].l = 12001;
seg.m_sides [3].uvls [2].u = - 2048;
seg.m_sides [3].uvls [2].v = 2047;
seg.m_sides [3].uvls [2].l = 12001;
seg.m_sides [3].uvls [3].u = - 2048;
seg.m_sides [3].uvls [3].v = 0;
seg.m_sides [3].uvls [3].l = 11678;

seg.m_sides [4].m_info.nWall = NO_WALL;
seg.m_sides [4].m_info.nBaseTex = 0;
seg.m_sides [4].m_info.nOvlTex = 0;
seg.m_sides [4].uvls [0].u = 0;
seg.m_sides [4].uvls [0].v = 0;
seg.m_sides [4].uvls [0].l = 0x8000U;
seg.m_sides [4].uvls [1].u = 0;
seg.m_sides [4].uvls [1].v = 2043;
seg.m_sides [4].uvls [1].l = 0x8000U;
seg.m_sides [4].uvls [2].u = - 2044;
seg.m_sides [4].uvls [2].v = 2045;
seg.m_sides [4].uvls [2].l = 0x8000U;
seg.m_sides [4].uvls [3].u = - 2043;
seg.m_sides [4].uvls [3].v = 0;
seg.m_sides [4].uvls [3].l = 0x8000U;

seg.m_sides [5].m_info.nWall = NO_WALL;
seg.m_sides [5].m_info.nBaseTex = 0;
seg.m_sides [5].m_info.nOvlTex = 0;
seg.m_sides [5].uvls [0].u = 0;
seg.m_sides [5].uvls [0].v = 0;
seg.m_sides [5].uvls [0].l = 24576;
seg.m_sides [5].uvls [1].u = 0;
seg.m_sides [5].uvls [1].v = 2048;
seg.m_sides [5].uvls [1].l = 24576;
seg.m_sides [5].uvls [2].u = - 2048;
seg.m_sides [5].uvls [2].v = 2048;
seg.m_sides [5].uvls [2].l = 24576;
seg.m_sides [5].uvls [3].u = - 2048;
seg.m_sides [5].uvls [3].v = 0;
seg.m_sides [5].uvls [3].l = 24576;
