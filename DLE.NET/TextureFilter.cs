...
namespace DLE.NET
{
    public class TextureFilter
    {
        ...
        FilterInfo[] texFiltersD2 = new FilterInfo [TEXFILTER_SIZE_D2]  {
	        ...
	        new FilterInfo (348, 349, Type.LIGHT, Type.STEEL | Type.MOVE),
	        new FilterInfo (350, 350, Type.GRATE, Type.STEEL | Type.MOVE),
	        new FilterInfo (351, 351, Type.SIGN, Type.LABEL),
	        new FilterInfo (352, 352, Type.SIGN, Type.LIGHT | Type.MOVE),
