...
{
if (bInitialize) {
	GetPrivateProfileString ("DLE-XP", "DescentDirectory", descentFolder [0], descentFolder [0], sizeof (descentFolder [0]), INIFILE);
	strcpy_s (m_d1Folder, sizeof (m_d1Folder), descentFolder [0]);
	CompletePath (m_d1Folder, "descent.pig", ".pig");
	GetPrivateProfileString ("DLE-XP", "Descent2Directory", descentFolder [1], descentFolder [1], sizeof (descentFolder [1]), INIFILE);
	strcpy_s (m_d2Folder, sizeof (m_d2Folder), descentFolder [1]);
	CompletePath (m_d2Folder, "groupa.pig", ".pig");
	GetPrivateProfileString ("DLE-XP", "LevelsDirectory", missionFolder, missionFolder, sizeof (missionFolder), INIFILE);
	strcpy_s (m_missionFolder, sizeof (m_missionFolder), missionFolder);
	CompletePath (m_missionFolder, "descent2.hog", ".hog");
	GetPrivateProfileString ("DLE-XP", "PlayerProfile", szPlayerProfile, szPlayerProfile, sizeof (szPlayerProfile), INIFILE);
	...
	m_depthPerception = GetPrivateProfileInt ("DLE-XP", "DepthPerception", 2, INIFILE);
	m_iRotateRate = GetPrivateProfileInt ("DLE-XP", "RotateRate", 4, INIFILE);
	...
	GetPrivateProfileString ("DLE-XP", "ViewMoveRate", "1", szMoveRate, sizeof (szMoveRate), INIFILE);
...
m_objViewFlags = GetPrivateProfileInt ("DLE-XP", "ObjViewFlags", m_objViewFlags, INIFILE);
m_texViewFlags = GetPrivateProfileInt ("DLE-XP", "TexViewFlags", m_texViewFlags, INIFILE);
//m_bApplyFaceLightSettingsGlobally = GetPrivateProfileInt ("DLE-XP", "ApplyFaceLightSettingsGlobally", m_bApplyFaceLightSettingsGlobally, INIFILE);
m_bSortObjects = GetPrivateProfileInt ("DLE-XP", "SortObjects", m_bSortObjects, INIFILE);
m_bDepthTest = GetPrivateProfileInt ("DLE-XP", "DepthTest", m_bDepthTest, INIFILE);
m_nViewDist = GetPrivateProfileInt ("DLE-XP", "ViewDistance", 0, INIFILE);
//m_nRenderer = GetPrivateProfileInt ("DLE-XP", "Renderer", 0, INIFILE);
m_nPerspective = GetPrivateProfileInt ("DLE-XP", "Perspective", 0, INIFILE);
...
if (bSaveFolders) {
	WritePrivateProfileString ("DLE-XP", "DescentDirectory", descentFolder [0], INIFILE);
	WritePrivateProfileString ("DLE-XP", "Descent2Directory", descentFolder [1], INIFILE);
	WritePrivateProfileString ("DLE-XP", "levelsDirectory", missionFolder, INIFILE);
	}
WritePrivateProfileString ("DLE-XP", "PlayerProfile", szPlayerProfile, INIFILE);
