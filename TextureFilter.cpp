...
static tTexFilterInfo texFiltersD1 [TEXFILTER_SIZE_D1] = {
	...
	{{327, 327}, TEX_SIGN, TEX_LIGHT | TEX_MOVE},
	{{328, 328}, TEX_ENERGY, TEX_LIGHT},
	{{329, 329}, TEX_FAN, 0},
	{{330, 331}, TEX_SIGN, TEX_LIGHT | TEX_MOVE},
...
static tTexFilterInfo texFiltersD2 [TEXFILTER_SIZE_D2] = {
	...
	{{340, 347}, TEX_LIGHT, 0},
	{{348, 349}, TEX_LIGHT, TEX_STEEL | TEX_MOVE},
	{{350, 350}, TEX_GRATE, TEX_STEEL | TEX_MOVE},
	{{351, 351}, TEX_SIGN, TEX_LABEL},
	{{352, 352}, TEX_SIGN, TEX_LIGHT | TEX_MOVE},
...
do {
	m = (l + r) / 2;
	if (nTexture < m_filter [m].m_range.nMin)
		r = m - 1;
	else if (nTexture > m_filter [m].m_range.nMax)
		l = m + 1;
	else
		return m;
	}
