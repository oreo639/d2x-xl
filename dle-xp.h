...
public:
	...
	inline CWnd *TexturePane () { return MainFrame ()->TexturePane (); }

	inline CWnd *MinePane () { return MainFrame ()->MinePane (); }

	inline CWnd *ToolPane () { return MainFrame ()->ToolPane (); }

	inline CSize& ToolSize () { return ToolView ()->ToolSize (); }
