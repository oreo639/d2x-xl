...
namespace WeifenLuo.WinFormsUI.Docking
{
	...
	public partial class DockPane : UserControl, IDockDragSource
	{
		...
		internal Rectangle ContentRectangle
		{
			get
			{
                ...
                if (!rectCaption.IsEmpty)
                    y += rectCaption.Height;
                if (!ForceToolWindowStyle && (DockState == DockState.Document) && (DockPanel.DocumentTabStripLocation == DocumentTabStripLocation.Top))
		...
		private bool HasCaption
		{
			get
			{
                return ((!ForceToolWindowStyle && DockState == DockState.Document) ||
                        DockState == DockState.Hidden ||
                        DockState == DockState.Unknown ||
                        (DockState == DockState.Float && FloatWindow.VisibleNestedPanes.Count <= 1)) ? false : true;
                //return ((ForceToolWindowStyle || (DockState != DockState.Document)) &&
                //        (DockState != DockState.Hidden) &&
                //        (DockState != DockState.Unknown) &&
		...
		internal void SetIsActivated(bool value)
		{
			...
			m_isActivated = value;
			if (DockState != DockState.Document || ForceToolWindowStyle)
        ...
        private bool m_forceToolWindowStyle = false;
        public bool ForceToolWindowStyle
        {
            set 
            { 
                m_forceToolWindowStyle = value; 
            }
            get 
            { 
                return m_forceToolWindowStyle; 
            }
        }
        
        public AppearanceStyle Appearance
		{
            get { return (ForceToolWindowStyle || (DockState != DockState.Document)) ? AppearanceStyle.ToolWindow : AppearanceStyle.Document; }
		}
